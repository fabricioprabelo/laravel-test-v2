    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                <template #title>
                    {{ $t('lang.pages.teams.team_settings.add_member') }}
                </template>

                <template #description>
                    {{ $t('lang.pages.teams.team_settings.add_member_description') }}
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                            {{ $t('lang.pages.teams.team_settings.add_member_description2') }}
                        </div>
                    </div>

                    <!-- Member Email -->
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="email" :value="$t('lang.email')" />
                        <TextInput
                            id="email"
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        <InputLabel for="roles" :value="$t('lang.role')" />
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title>
                    {{ $t('lang.pages.teams.team_settings.pendding_invitations') }}
                </template>

                <template #description>
                    {{ $t('lang.pages.teams.team_settings.pendding_invitations_description') }}
                </template>
        ...
        <div v-if="team.users.length > 0">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title>
                    {{ $t('lang.pages.teams.team_settings.team_members') }}
                </template>

                <template #description>
                    {{ $t('lang.pages.teams.team_settings.team_members_description') }}
                </template>
        ...
        <DialogModal :show="currentlyManagingRole" @close="currentlyManagingRole = false">
            <template #title>
                {{ $t('lang.pages.teams.team_settings.manage_role') }}
            </template>
        ...
        <ConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            <template #title>
                {{ $t('lang.pages.teams.team_settings.leave_team') }}
            </template>

            <template #content>
                {{ $t('lang.pages.teams.team_settings.leave_team_confirmation') }}
            </template>
        ...
        <ConfirmationModal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
            <template #title>
                {{ $t('lang.pages.teams.team_settings.remove_team_member') }}
            </template>

            <template #content>
                {{ $t('lang.pages.teams.team_settings.remove_team_member_confirmation') }}
            </template>
